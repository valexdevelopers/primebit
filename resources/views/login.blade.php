	...
	<body oncut="return false" class="menuclose menuclose-right" style="background:gray">
		...
		<div class="wrapper-content-sign-in p-0">
			...
			<div class="col-md-8 offset-md-8 text-left side_signing_full">
				...
				<form class="form-signin1 full_side text-white " action="{{ route('site.login.store') }}" method="POST">
					@csrf
					...
					<br>
					<p class="mt-3"><a href="register.html" class="text-white">Register here!</a> <br>
					<a  style="color:#0080db" href="{{ route('password.request') }}" class="">Forgot password?</a></p>
				</form>
				<br>
			</div>  
		</div>
