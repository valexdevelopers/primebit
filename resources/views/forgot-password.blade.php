...
<html lang="en">
	<head>
		...
		<title>Forgot Password | PrimeBitfx</title>
	...
	<body oncut="return false" class="menuclose menuclose-right" style="background:gray">
		...
		<div class="wrapper-content-sign-in p-0">
			...
			<div class="col-md-8 offset-md-8 text-left side_signing_full">
				...
				<form class="form-signin1 full_side text-white " action="{{ route('password.email') }}" method="POST">
					@csrf
					...
					@else
						<div class="alert alert-secondary alert-dismissible fade show">
							<strong>Forgot your password? enter your email and we will email you a password reset link.</strong>
						</div>
					@endif
		...
		<script type="text/javascript">
			...
			var names = ['valex', 'Hunter', 'Connor', 'Amelia'];
