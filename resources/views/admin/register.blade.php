...
<html lang="en">
    <head>
        ...
        <title>Admin Register | PrimeBitfx </title> 
	...
	<header class="navbar-fixed">
		<nav class="navbar navbar-toggleable-md sign-in-header">
			...
			<div class="sidebar-right pull-right">
				<ul class="navbar-nav  justify-content-end">
					...
					<li style="margin:4px"><a href="{{ route('admin.login.create') }}" style="background:#3f48cc;color:white" class="btn btn-primary">Login</a></li>
					<li style="margin:4px"><a href="{{ route('admin.register.create') }}" style="background:#3f48cc;color:white" class="btn btn-primary">Register</a></li>
				</ul>
			</div>
		</nav>
	</header>
  	<div class="wrapper-content-sign-in p-0">
		<div class="col-md-8 offset-md-8 text-left side_signing_full">
			...
			<form class="form-signin1 full_side text-white" action="{{ route('admin.register.store') }}" method="POST">
				@csrf
				@if($errors->any())
				...
				<h2 class="tex-black mb-4">Admin Register</h2>
				<label style="color:black" class="font-weight-bold">Full Name</label>
				<input type="text" style="color:black"  class="form-control @error('fullname')  is-invalid @enderror" name="fullname" placeholder="First Name" value="" required>
				@error('fullname')
